# 📊 Enterprise-Grade Automated Expense Tracker & Analytics Ecosystem
...
## 📊 Power BI "Expense Tracker" Dashboard

The interactive business intelligence layer picks up where local tracking leaves off. It converts raw historical transaction strings into executive visual analytics.
...
## 💾 How To Run Locally
1. Download both the `Automated_Expense_Tracker.xlsm` file and the `Expense_Tracker.pbix` file.
